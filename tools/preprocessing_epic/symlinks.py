"""Restructure the dataset by making symlinks to match the structure of 
EPIC-fusion and TSN

Reference: https://github.com/ekazakos/temporal-binding-network/blob/master/preprocessing_epic/symlinks.py
"""
import sys
import argparse
