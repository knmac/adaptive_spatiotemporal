...
python tools/extract_actreg_from_pipeline.py \
    --weight        "/home/knmac/Dropbox/SparseSensing/DGX_training_logs/finetuned_pipeline5_112/finetune_pipeline5__top2_nofc1_1024hid_2lay/best.model" \
    --output_dir    "pretrained/finetuned/actreggru2_top2_cat__nofc1_1024hid_2lay"
