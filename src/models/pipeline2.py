...
class Pipeline2(BaseModel):
    """Pipeline with separate hallucinator and action recognition"""
    def __init__(self, device, model_factory, num_class, num_segments, modality,
                 ...
                 hallu_model_cfg, hallu_loss):
        super(Pipeline2, self).__init__(device)
    ...
    def forward(self, x):
        ...
        # Action recognition with RNN
        output = self.actreg_model(x)

        # Hallucination of future attention
